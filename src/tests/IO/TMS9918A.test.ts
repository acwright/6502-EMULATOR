import { TMS9918A, TmsMode, TmsColor } from '../../core/IO/TMS9918A'
 ...
 */
const writeRegister = (vdp: TMS9918A, reg: number, value: number): void => {
 ...
 */
const setWriteAddress = (vdp: TMS9918A, addr: number): void => {
 ...
 */
const setReadAddress = (vdp: TMS9918A, addr: number): void => {
  vdp.write(1, addr & 0xFF)           // Stage 0: address low byte
 ...
 */
const writeVramBytes = (vdp: TMS9918A, addr: number, bytes: number[]): void => {
 ...
 */
const setupGraphicsI = (vdp: TMS9918A): void => {
 ...
 */
const setupGraphicsII = (vdp: TMS9918A): void => {
 ...
 */
const setupTextMode = (vdp: TMS9918A): void => {
 ...
 */
const renderOneFrame = (vdp: TMS9918A, frequency: number = 1000000): void => {
 ...
 */
const clearSprites = (vdp: TMS9918A, spriteAttrAddr: number = 0x3B00): void => {
...
describe('frameIndices', () => {
  ...
  const rgbaAt = (vdp: TMS9918A, pixel: number): number[] =>
