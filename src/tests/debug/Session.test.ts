...
describe('Session', () => {
   ...
   * arming one breakpoint — the coverage harness armed one per Kernal entry —
   * shifted when each pasted byte reached the ACIA and when its IRQ landed. It
   * was enough to decide whether a race in EhBASIC crashed.
   *
